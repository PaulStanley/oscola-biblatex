...
The guidance given on citation of UN documents in the third edition of \oscolashort\ is
...
cannot guess when it should be added. Note also that for some pre-1976 document, the date is part of the official document number
