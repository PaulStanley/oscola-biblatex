...
\def\releasedate{24 October 2013}
...
\item[\texttt{citereset}]
                 \index[general]{customization!shortened citations}
                 \index[general]{options!citetracker@\texttt{citetracker}}
                 \index[general]{references!shortened forms}
    This option allows you to reset the cross-references to previous notes.
    A sensible option is to use \texttt{citereset={}chapter} to make sure that
    no cross-references point to previous chapters.
